...
class PpdAwardNextScreenArguments {
  String editModel;

  PpdAwardNextScreenArguments(this.editModel);
}

class PpdAwardNextScreen extends BaseStatefulWidget {
  static const routeName = '/PpdAwardNextScreen';

  final PpdAwardNextScreenArguments arguments;

  PpdAwardNextScreen(this.arguments);

  @override
  _PpdAwardNextScreenState createState() => _PpdAwardNextScreenState();
}

class _PpdAwardNextScreenState extends BaseState<PpdAwardNextScreen>
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () {
                                  navigateTo(
                                      context, PpdAwardNextScreen.routeName);
                                },
                                child: Container(
                                  margin: EdgeInsets.all(10),
                                  child: Card(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.all(20),
                      child: Text(
                          "This tool is available as a self help tool. We cannot guara ntee the accuracy of applicability in regards to your circumstances."),
                    ),
                    SizedBox(
                      height: 30,
                    ),
